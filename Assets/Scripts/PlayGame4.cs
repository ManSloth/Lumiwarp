...
public class PlayGame4 : MonoBehaviour {
	...
	void Start () {
        ...
        startScore = 15;
        scoreValue = startScore;
        scoreValue2 = startScore;
	...
	void Update () {
        ...
        if(scoreValue == (startScore+startScore))
        {
        ...
        if (scoreValue2 == (startScore + startScore))
        {
            if (Social.localUser.authenticated)
            {
                if (!incAchieve)
